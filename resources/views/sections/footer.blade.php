<footer class="fluid-container bg-blue">
  <div class="md:max-w-[1000px] md:px-3 lg:py-[50px] mx-auto pt-[25px] pb-[20px] px-3 flex flex-col md:flex-row gap-4">
    ...
    <div class="md:w-1/5 flex md:my-0 my-3">
    ...
    <div class="md:w-1/5 flex md:my-0 my-3">
      ...
      @endif</div>
    <div class="md:w-1/5 flex flex-row gap-6 md:my-0 my-3">
